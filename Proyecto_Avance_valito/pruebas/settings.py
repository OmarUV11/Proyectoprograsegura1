...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join('pruebas/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT = '/home/erik/Descargas/ProyectoSeg/archivos/'
MEDIA_URL = '/archivos/'

MEDIA_ROOT_PROFESOR = '/home/erik/Descargas/ProyectoSeg/Ejercicios_Profesor/'
MEDIA_URL_PROFESOR = '/Ejercicios_Profesor/'
